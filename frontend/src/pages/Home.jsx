    ...
    <div className="min-h-screen">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in">
          <h1 className="text-6xl md:text-8xl font-bold text-[#FFE000] mb-6 tracking-tight">
            GoldenFX
          </h1>
      ...
      {/* Yellow divider */}
      <div className="h-px bg-[#FFE000]/20 max-w-7xl mx-auto"></div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <a
              ...
              className="bg-[#0a0a0a] border-2 border-[#FFE000] rounded-lg p-8 hover:shadow-[0_0_16px_rgba(255,224,0,0.4)] transition-all duration-300 group"
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 rounded-full bg-[#FFE000]/10 flex items-center justify-center">
                  <svg
                    viewBox="0 0 24 24"
                    width="24"
                    height="24"
            ...
            {/* Discord Card */}
            <div className="bg-[#0a0a0a] border-2 border-[#FFE000] rounded-lg p-8 hover:shadow-[0_0_16px_rgba(255,224,0,0.4)] transition-all duration-300 group">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 rounded-full bg-[#FFE000]/10 flex items-center justify-center">
                  <svg
                    viewBox="0 0 24 24"
